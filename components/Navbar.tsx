          ...
          <div className="navbar-actions">
            ...
            {user ? (
              <>
                ...
                <div ref={menuRef} className={`navbar-user-menu${menuOpen ? " navbar-user-menu--open" : ""}`}>
                  <button
                    type="button"
                    onClick={() => setMenuOpen((open) => !open)}
                    className="navbar-user-menu-trigger d-only"
                  ...
                  {menuOpen && (
                    <div className="navbar-user-menu-panel" role="menu">
                      <div className="navbar-user-menu-panel-inner">
                        <div className="navbar-user-menu-head">
                          <div className="navbar-user-menu-head-name">{user.name}</div>
                          <div className="navbar-user-menu-head-email">{user.email}</div>
                        </div>
                        {user.role === "ADMIN" && (
                          <Link href="/admin" role="menuitem" className="navbar-user-menu-item navbar-user-menu-item--admin" onClick={() => setMenuOpen(false)}>
                            Kontrol Paneli
                          </Link>
                        )}
                        {[
                          ...
                          <Link key={item.href} href={item.href} role="menuitem" className="navbar-user-menu-item" onClick={() => setMenuOpen(false)}>
                            {item.label}
                        ...
                        <button type="button" role="menuitem" onClick={() => { setMenuOpen(false); logout(); }} className="navbar-user-menu-item navbar-user-menu-item--logout">
                          Çıkış yap
                        </button>
                      </div>
                    </div>
