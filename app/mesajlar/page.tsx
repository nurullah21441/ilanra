...
function MesajlarContent() {
  ...
  const [me, setMe] = useState<{ id: string; name: string; isVerified: boolean } | null>(null);
                ...
                <div className="messages-compose">
                  {me && !me.isVerified ? (
                    <div style={{ padding: "12px 14px" }}>
                      <VerifyEmailPrompt
                        compact
                        title="Mesaj göndermek için e-postanı doğrula"
                        subtitle="Satıcılarla iletişime geçmeden önce e-posta adresini doğrulaman gerekiyor."
                      />
                    </div>
                  ) : (
                    <>
