...
import { notifySavedSearchesForListing } from "@/lib/saved-search-notify";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    notifySavedSearchesForListing(listing.id).catch((err) => {
      console.error("[saved-search] Bildirim hatası:", err);
    });
